# -*- coding: utf-8 -*-
"""
Orginial script is from Annabel Beichman
Adapted by Tanya Phung for the Turkana demography history inference
"""
import os
import matplotlib
...
# note: module  Demographics1D has the following models file: https://github.com/paulirish/dadi/blob/master/doc/api/toc-dadi.Demographics1D-module.html
